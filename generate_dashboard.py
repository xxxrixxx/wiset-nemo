...
sections = [
    {"icon": "briefcase", "title": "업종 분석", "items": [
        {"img": "images/top_business_large.png", "title": "전체 업종 분포", "text": "상위 업종의 높은 분포는 검증된 모델을 의미합니다. 틈새 시장 노리는 경우 역발상적 접근이 가능합니다."}, 
        {"img": "images/region_industry_stacked.png", "title": "지역별 업종 분포(누적)", "text": "주요 역세권 상권은 F&B 및 서비스 업종이 독점적 우위를 점합니다. 지역별 특성에 맞는 전략적 포지셔닝이 필수입니다."}
    ]},
    {"icon": "trending-up", "title": "비용 및 효율성", "items": [
        {"img": "images/premium_by_industry.png", "title": "업종별 권리금", "text": "주류점 등은 고위험-고수익 구조입니다. 투자비 회수 지표로 권리금을 확인하세요."}, 
        {"img": "images/size_rent_efficiency.png", "title": "면적 대비 임대료", "text": "소형 평수는 입지에 따라 가격 편차가 큽니다. 입지가 과대평가된 매물을 가려내는 것이 핵심입니다."}
    ]}
]
...
<style>
    ...
    <div class='glass p-6 mb-8'>
        <h2 class='text-2xl font-bold text-white mb-6 flex items-center gap-3'>
            <i data-lucide='{g['icon']}'></i>{g['title']}
        </h2>
